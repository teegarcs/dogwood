...
val generateAcme by tasks.registering(JavaExec::class) {
  ...
  outputs.file(rootProject.file("../docs/api/acme.designsystem.md"))
  ...
  argumentProviders.add {
    ...
    listOf(
      ...
      // A product's own reference, generated by the same generator from its own surface. It is
      // here as much to show that a product gets one as to document these three components.
      "--docs-out", rootProject.file("../docs/api/acme.designsystem.md").absolutePath,
    )
  }
}
