...
| E6 | **The 22.1 ms GC outlier** | Perf | attributed or reproduced-and-bounded; the one loose thread in the Phase 0 numbers |
| E7 | **androidx import migration script** | Authoring | the "port, not a re-import" minus: a mechanical rewriter for the import prefix and the known signature deltas, with its limits stated |
