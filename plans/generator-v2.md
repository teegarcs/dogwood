...
| # | Milestone | Gate |
|---|---|---|
| **M0** | This plan; ADR-072; the consolidated backlog below | committed |
...
| **M3** | **The page-weight decision, measured.** Three builds per D-H; the owner decides | `budgets.tsv` and ADR-066's rule honoured, whatever is decided |
