...
@Composable
fun ReferenceScreen(state: ReferenceScreenState, rows: Int = REFERENCE_ROWS) {
...
@Composable
private fun Header(state: ReferenceScreenState) {
...
@Composable
private fun ItemList(state: ReferenceScreenState, rows: Int) {
...
@Composable
private fun ItemRow(state: ReferenceScreenState, index: Int) {
...
@Composable
private fun Footer(state: ReferenceScreenState) {
