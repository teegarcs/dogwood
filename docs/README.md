...
| **Reviewing this for security** | [`security.md`](security.md) | you can name the boundary that answers each threat in its table, and the two residual risks it says are not prevented — "sandbox" here means capability-confined, not isolated |
